...
@Entity(tableName = "game", foreignKeys = [ForeignKey(entity = UserEntity::class, parentColumns = ["server_id"], childColumns = ["player1"], onDelete = ForeignKey.CASCADE),
    ForeignKey(entity = UserEntity::class, parentColumns = ["server_id"], childColumns = ["player2"], onDelete = ForeignKey.SET_NULL)],
